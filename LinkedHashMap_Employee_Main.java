...
public class LinkedHashMap_Employee_Main 
{
	...
	public static void main(String[] args) 
	{
		...
		n=sc.nextInt();
		Map<Integer,LinkedHashMap_Employee> map=new LinkedHashMap<Integer,LinkedHashMap_Employee>();//creating HashMap of class type LinkedHashMap_Employee
		...
		//returning elements from LinkedHashMap
